(async () => {
    try {
        ...
        */
         ...
         */
        //await dv.view("02 Dateien/Javascript/dv_insert", { target: "A", msg: toRender}) //this function hard-writes toRender into the current file. This has proven to be problematic for searching because recall is increased and precision is lost
        dv.paragraph(`> [!example]- In diesem Zusammenhang:\n ${toRender}`)
        dv.container.className += ' related-container'
